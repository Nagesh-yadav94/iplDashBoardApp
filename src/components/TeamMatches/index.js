...
class TeamMatches extends Component {
  ...
  getTeamMatches = async () => {
    ...
    const updateFetchData = {
      teamBnnerUrl: fetchData.team_banner_url,
      latestMatchDetails: {
    ...
    this.setState({matchesData: updateFetchData, isLoading: false})
  }

  renderTeamMatches = () => {
    const {matchesData} = this.state
    const {teamBnnerUrl, latestMatchDetails} = matchesData

    return (
      <div className="team-matches-container">
        <img className="team-banner" alt="team banner" src={teamBnnerUrl} />
